...
USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.6155.1 Safari/537.36"

def download_m3u8(url, user_agent=USER_AGENT):
...
def extrace_header(m3u8_content):
    m3u8_header = ""
    #遇到 #extinf为止
    for line in m3u8_content:
...
def find_and_remove_ads(file_path, threshold=10, output_dir=""):
    ...
    m3u8_header_line = extrace_header(m3u8_content)
